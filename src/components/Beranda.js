        ...
        <div className="group  bg-slate-50 shadow-indigo-500/50 shadow-xl drop-shadow-2xl p-7 rounded-xl transition duration-300 hover:bg-[#2A8EE4]">
          <div className="block">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M45.9375 74.375H59.0625V63.4375H70V50.3125H59.0625V39.375H45.9375V50.3125H35V63.4375H45.9375V74.375ZM17.5 91.875V39.375L52.5 13.125L87.5 39.375V91.875H17.5ZM26.25 83.125H78.75V43.75L52.5 24.0625L26.25 43.75V83.125Z" />
            </svg>
          </div>
          <Link href={"/klinik-anak"}>
            <div className="flex flex-col gap-4">
        ...
        <div className="group bg-slate-50 shadow-indigo-500/50 shadow-xl drop-shadow-2xl p-7 rounded-xl transition duration-300 hover:bg-[#2A8EE4]">
          <div className="block">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M56.875 17.5H48.125L43.75 8.75H61.25L56.875 17.5ZM83.125 56.875V96.25H21.875V56.875C21.875 44.8 31.675 35 43.75 35V26.25H39.375V21.875H65.625V26.25H61.25V35C73.325 35 83.125 44.8 83.125 56.875ZM74.375 56.875C74.375 49.6563 68.4688 43.75 61.25 43.75H43.75C36.5313 43.75 30.625 49.6563 30.625 56.875V87.5H74.375V56.875ZM65.625 70H56.875V78.75H48.125V70H39.375V61.25H48.125V52.5H56.875V61.25H65.625V70Z" />
            </svg>
          </div>
          <Link href={"/klinik-anak"}>
            <div className="flex flex-col gap-4">
