  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center">
        <div className="group gap-2 bg-slate-50 shadow-indigo-500/50 shadow-xl drop-shadow-2xl p-7 rounded-xl transition duration-300 hover:bg-[#2A8EE4]">
          <div className="block">
            <svg
