  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center lg:flex-row flex-wrap p-0 ">
        ...
        <div className="flex flex-col items-center justify-center lg:flex-row py-8 px-4 gap-5">
          ...
          <div className=" relative w-[400px] h-[500px]  transform-style-preserve-3d transition-transform duration-700 hover:rotate-y-180">
            ...
            <div className="card-back bg-[#2A8EE4] text-white flex flex-col p-12 gap-8 justify-center shadow-2xl rounded-[10px]  absolute w-full h-full backface-hidden rotate-y-180">
              ...
              <div className="gap-5">
                <h1 className="font-bold text-3xl">Klinik Umum</h1>
                <p>
                  Memberikan pelayanan Radiologi, Laboratorium hematologi
                  klinik, Laboratorium mikrobiologi, Elektrokardiografi (EKG),
                  Layanan Konseling, Rujukan Spesialistik.
                </p>
              </div>
              <Link
                href="/Sejarah"
            ...
            <div className="card-back bg-[#2A8EE4] text-white flex flex-col p-12 gap-8 justify-center shadow-2xl rounded-[10px]  absolute w-full h-full backface-hidden rotate-y-180">
              ...
              <div className="gap-5">
                ...
                <p>
                  ...
                  lengkap, Urin Rutin, Urin lengkap, Kimia Klinik, Dahak (TCM
                  dan Mikroskopis), Immunoserolog( Rapid dan Swab).
                </p>
              </div>
              <Link
                href="/Sejarah"
